 ...
 *
 */
public class mgaikwadPokerSquaresPointSystem {
	private static final Random random = new Random(); // pseudorandom number generator
	private static final int MAX_HAND_SCORE = 12777; // maximum permissible hand score
	private static final int MIN_HAND_SCORE = -12888; // maximum permissible hand score
	private static final int SIZE = mgaikwadPokerSquares.SIZE; // Poker Squares number of rows/columns
	 ...
	 */
	public mgaikwadPokerSquaresPointSystem(int[] scores) {
	 ...
	 */
	public int getHandScore(mgaikwadCard[] hand) {
		return scores[mgaikwadPokerHand.getPokerHandId(hand)];
	}
	 ...
	 */
	public int getHandScore(mgaikwadPokerHand pokerHand) {
	 ...
	 */
	public int getScore(mgaikwadCard[][] grid) {
	 ...
	 */
	public int[] getHandScores(mgaikwadCard[][] grid) {
		int[] handScores = new int[2 * SIZE];
		for (int row = 0; row < SIZE; row++) {
			mgaikwadCard[] hand = new mgaikwadCard[SIZE];
	 ...
	 * @return a random point system with scores uniformly distributed across the range of all allowable values
	 */
	public static mgaikwadPokerSquaresPointSystem getRandomPointSystem() {
		int[] scores = new int[mgaikwadPokerHand.NUM_HANDS];
		for (int i = 0; i < mgaikwadPokerHand.NUM_HANDS; i++)
			scores[i] = random.nextInt(MAX_HAND_SCORE - MIN_HAND_SCORE + 1) + MIN_HAND_SCORE;
		return new mgaikwadPokerSquaresPointSystem(scores);
	}
	 ...
	 * @return a random hypercorner point system where hand scores are either -1 or 1 with equal probability
	 */
	public static mgaikwadPokerSquaresPointSystem getHypercornerPointSystem() {
		int[] scores = new int[mgaikwadPokerHand.NUM_HANDS];
		for (int i = 0; i < mgaikwadPokerHand.NUM_HANDS; i++)
	 ...
	 * scores 1 point
	 */
	public static mgaikwadPokerSquaresPointSystem getSingleHandPointSystem(int pokerHandId) {
		int[] scores = new int[mgaikwadPokerHand.NUM_HANDS];
	 ...
	 * @return a point system where only one randomly selected Poker hand scores 1 point
	 */
	public static mgaikwadPokerSquaresPointSystem getSingleHandPointSystem() {
		return getSingleHandPointSystem(random.nextInt(mgaikwadPokerHand.NUM_HANDS));
	}
	 ...
	 * @return the American point system
	 */
	public static mgaikwadPokerSquaresPointSystem getAmericanPointSystem() {
		return new mgaikwadPokerSquaresPointSystem(new int[] {0, 2, 5, 10, 15, 20, 25, 50, 75, 100});
	}
	 ...
	 */
	public static mgaikwadPokerSquaresPointSystem getBritishPointSystem() {
		return new mgaikwadPokerSquaresPointSystem(new int[] {0, 1, 3, 6, 12, 5, 10, 16, 30, 30});
	}
	 ...
	 * @return an "Ameritish" point system randomly generated between the normalized point ranges established by the American and British systems
	 */
	public static mgaikwadPokerSquaresPointSystem getAmeritishPointSystem() {
		...
		return new mgaikwadPokerSquaresPointSystem(ameritish);
	}
	 ...
	 */
	public void printGrid(mgaikwadCard[][] grid) {
		// get scores
		int[] handScores = getHandScores(grid);
		int totalScore = 0;
		for (int handScore : handScores)
	...
	public String toString() {
		...
		for (mgaikwadPokerHand hand : mgaikwadPokerHand.values())
