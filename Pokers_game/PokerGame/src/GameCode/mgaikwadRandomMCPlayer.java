 ...
 */
public class mgaikwadRandomMCPlayer implements mgaikwadPokerSquaresPlayer {
	
	private final int SIZE = 5; // number of rows/columns in square grid
	private final int NUM_POS = SIZE * SIZE; // number of positions in square grid
	private final int NUM_CARDS = mgaikwadCard.NUM_CARDS; // number of cards in deck
	...
	private mgaikwadPokerSquaresPointSystem system; // point system
	private int depthLimit = 2; // default depth limit for Random Monte Carlo (MC) play
	private mgaikwadCard[][] grid = new mgaikwadCard[SIZE][SIZE]; // grid with Card objects or null (for empty positions)
	private mgaikwadCard[] simDeck = mgaikwadCard.getAllCards(); // a list of all Cards. As we learn the index of cards in the play deck,
	 ...
	 */
	public mgaikwadRandomMCPlayer(int depthLimit) {
	 ...
	 */
	@Override
	public int[] getPlay(mgaikwadCard card, long millisRemaining) {
		/*
	...
	public void makePlay(mgaikwadCard card, int row, int col) {
	 ...
	 */
	@Override
	public void setPointSystem(mgaikwadPokerSquaresPointSystem system, long millis) {
		this.system = system;
	}
	...
	public static void main(String[] args) {
		mgaikwadPokerSquaresPointSystem system = mgaikwadPokerSquaresPointSystem.getAmeritishPointSystem();
		System.out.println(system);
		new mgaikwadPokerSquares(new mgaikwadRandomMCPlayer(2), system).play(); // play a single game
	}
