 ...
 */
public interface mgaikwadPokerSquaresPlayer {
	 ...
	 */
	void setPointSystem(mgaikwadPokerSquaresPointSystem system, long millis); 
	 ...
	 */
	int[] getPlay(mgaikwadCard card, long millisRemaining);
